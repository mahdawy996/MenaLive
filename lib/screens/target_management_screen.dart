...
class _S extends State<TargetManagementScreen>{
 ...
 @override Widget build(BuildContext context)=>Directionality(textDirection:TextDirection.rtl,child:Scaffold(backgroundColor:const Color(0xFF0A0815),appBar:AppBar(title:const AppBarTitle('إدارة مستويات التاركت والمكافآت')),body:ListView(padding:const EdgeInsets.all(14),children:[
