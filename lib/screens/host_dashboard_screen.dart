...
class HostDashboardScreen extends StatelessWidget {const HostDashboardScreen({super.key});
 @override Widget build(BuildContext context)=>Directionality(textDirection:TextDirection.rtl,child:Scaffold(backgroundColor:const Color(0xFF0A0815),appBar:AppBar(title:const AppBarTitle('لوحة تحكم المضيف')),body:ListView(padding:const EdgeInsets.all(14),children:[
